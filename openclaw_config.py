...
PROVIDERS = {
    ...
    "deepseek": {
        ...
        "authHeader": False,
        "models": [
            {"id": "deepseek-chat",   "name": "DeepSeek Chat V3",   "contextWindow": 64000,  "maxTokens": 8192},
            {"id": "deepseek-reasoner","name": "DeepSeek R1",       "contextWindow": 64000,  "maxTokens": 8192},
            {"id": "deepseek-coder",  "name": "DeepSeek Coder V2",  "contextWindow": 128000, "maxTokens": 8192},
        ],
    },
    "openai": {
        "label": "OpenAI",
    ...
    "anthropic": {
        ...
        "authHeader": False,
        "models": [
            {"id": "claude-opus-4-5",   "name": "Claude Opus 4.5",   "contextWindow": 200000, "maxTokens": 8192},
    ...
    "openrouter": {
        ...
        "authHeader": False,
        "models": [
            {"id": "google/gemini-2.5-pro-preview",  "name": "Gemini 2.5 Pro",     "contextWindow": 1000000, "maxTokens": 65536},
    ...
    "siliconflow": {
        ...
        "models": [
            ...
            {"id": "Qwen/QwQ-32B-Preview",            "name": "QwQ-32B",            "contextWindow": 32768, "maxTokens": 8192, "reasoning": True},
        ],
    },
    "zhipu": {
        "label": "智谱 ZhipuAI",
        ...
        "models": [
            ...
            {"id": "glm-zero-preview", "name": "GLM Zero", "contextWindow": 16000,  "maxTokens": 4096, "reasoning": True},
        ],
    },
    "ollama": {
        "label": "Ollama (本地)",
        ...
        "authHeader": False,
        "models": [
            {"id": "llama3.2", "name": "Llama 3.2",     "contextWindow": 128000, "maxTokens": 8192},
            {"id": "qwen2.5",  "name": "Qwen 2.5",      "contextWindow": 32768,  "maxTokens": 4096},
